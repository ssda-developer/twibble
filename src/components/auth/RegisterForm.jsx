...
const RegisterForm = () => {
    ...
    const validateForm = (values) => {
        ...
        if (!username) {
            ...
            nextErrors.username = `Username must be ${USERNAME_MAX_LENGTH} characters or less.`;
        }
    ...
    const handleChange = (e) => {
        ...
        if (name === "displayName") {
            newValue = value.slice(0, DISPLAY_NAME_MAX_LENGTH);
        }

        if (name === "username") {
            newValue = value.replace(/[^a-zA-Z0-9._]/g, "").slice(0, USERNAME_MAX_LENGTH);
        }
